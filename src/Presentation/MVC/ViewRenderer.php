...
final class ViewRenderer
{
    ...
    public static function render(MVC $mvc, string $view, mixed $data): void
    {
        ...
        $link = function (string $content, string $controller, string $action, array $params = [], ?string $cssClass = null, bool $escapeContent = true) use ($mvc, $htmlOut) {
            $cc = $cssClass != null ? " class=\"$cssClass\"" : '';
            ...
            if ($escapeContent) {
                ...
                echo $content; // Output raw content
            }
            echo '</a>';
        };
